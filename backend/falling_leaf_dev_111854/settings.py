"""
Django settings for falling_leaf_dev_111854 project.
...
ROOT_URLCONF = 'falling_leaf_dev_111854.urls'
...
WSGI_APPLICATION = 'falling_leaf_dev_111854.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_leaf_dev_111854 API",
    "DESCRIPTION": "API documentation for falling_leaf_dev_111854 App",
    "VERSION": "v1",
}
